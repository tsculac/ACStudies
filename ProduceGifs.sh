...
convert -delay 10 -loop 0 Animations/D0P_*.png Animations/D0P.gif
convert -delay 10 -loop 0 Animations/DL1_*.png Animations/DL1.gif
convert -delay 10 -loop 0 Animations/DL1Zgs_*.png Animations/DL1Zgs.gif
convert -delay 10 -loop 0 Animations/DBKG_*.png Animations/DBKG.gif
